...
public class VentaDTO {
    ...
    public VentaDTO(Integer id_pedido, Integer id_funcionario, Integer id_cliente, String obs, String fecha, List<PedidoDetDTO> detalle) {
    ...
    public VentaDTO(Integer id_pedido, Integer id_funcionario, Integer id_cliente, String obs, String fecha, String nombrefuncionario, String nombrecliente) {
        this.id_pedido = id_pedido;
        this.id_funcionario = id_funcionario;
        this.id_cliente = id_cliente;
        this.obs = obs;
    ...
    public VentaDTO(Integer id_pedido, Integer id_producto, Integer pd_cant, Integer total, String pro_descrip) {
        this.id_pedido = id_pedido;
