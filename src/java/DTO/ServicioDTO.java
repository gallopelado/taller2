...
public class ServicioDTO {
  ...
  precioventa integer,
    ...
    public ServicioDTO(Integer id_producto, String descripcion_producto, Integer preciocompra_producto, Integer precioventa) {
    ...
    public ServicioDTO(Integer id_producto, String descripcion_producto, Integer precioventa) {
        this.id_producto = id_producto;
        this.descripcion_producto = descripcion_producto;
        this.precioventa = precioventa;
    }
