 ...
 * @author juan
 */
public class EspecialidadSRV extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("Llegó a EspecialidadSRV");
        ...
        Integer cupo = Integer.parseInt((request.getParameter("cupo").isEmpty() ? "0" : request.getParameter("cupo")));
